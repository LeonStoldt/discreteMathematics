...
> 3.	Koinzidenz pro Spalte ausrechnen  $K(m) = $
> 4.	Koinzidenzen auf bekannte Werte prüfen (bei deutschen Texten $K(m) = 0,0762$)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUxNTA2MzY1MSw0NjQ4NjM5MjAsNjA2OT
