...
3.	Baby Steps Tabelle $17^{-r} \: mod \: 31 = (17^{-1})^r \: mod \: 31 = 17^{29} \: mod \: 31 = 11$ - `multipilikatives Inverse zu 17 kann hier schnell berechnet werden, da 17 eine Primzahl ist` $\rightarrow g^{-1} = g$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NjU1MDI4NDAsNzk2NzM0MzU1LDEwOT
