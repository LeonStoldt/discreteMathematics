...
> Der diskrete Logarithmus von $y$ zur Basis $g$ ist der kleinste Exponent $x$ der Gleichung $a^x \equiv m \: mod \: p$ mit $(m,a \in \N; p \in P).$
> 
> $x = dlog_g (y)$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE3MjczNDY4OCwtMTczMTk1NTE5OSwtMT
