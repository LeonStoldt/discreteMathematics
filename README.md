...
> 2.	Der Sender und Empfänger bilden jeweils eine geheime Zahl $a \text{ bzw. } b$ und bilden damit $x = g^a \: mod \: p \text{ bzw. } y = g^b \: mod \: p$


### Integrität und Authentizität von Nachrichten
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIyNDQ1NjMyMiwtMTczMTk1NTE5OSwtMT
